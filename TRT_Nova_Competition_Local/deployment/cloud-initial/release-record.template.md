...
| 门禁 | 结果 | 证据 |
|---|---|---|
| 凭据轮换与仓库/包扫描 | TODO | TODO |
| 云媒体服务端生命周期 | TODO | TODO |
| 数据库备份与恢复演练 | TODO | TODO |
| 版本化迁移的空库/克隆验证 | TODO | TODO |
| 5 个函数可复现构建 | TODO | TODO |
| 5 个 Event Function + `cloud-entry.main_handler` 一致性 | TODO | TODO |
| Function URL event 结构兼容性（staging 实测） | TODO | TODO |
| SCF 自定义域名 path mapping/路径保留（staging 实测） | TODO | TODO |
| `secret://` 解析实现、最小权限和脱敏 | TODO | TODO |
...
|---|---|---|---:|---|---|---|---|
| auth-scf | `cloud-entry.main_handler` | TODO | TODO | TODO | TODO | TODO | TODO |
| api-scf | `cloud-entry.main_handler` | TODO | TODO | TODO | TODO | TODO | TODO |
| ingest-scf | `cloud-entry.main_handler` | TODO | TODO | TODO | TODO | TODO | TODO |
| agent-scf | `cloud-entry.main_handler` | TODO | TODO | TODO | TODO | TODO | TODO |
| history-cleanup-scf | `cloud-entry.main_handler` | TODO | TODO | TODO | TODO | TODO | TODO |

构建机 Node/npm、lockfile、`npm ci --omit=dev` 和源码白名单：TODO

## 5. Function URL、自定义域名与客户端

| 项目 | 结果 | 证据 |
|---|---|---|
| Event Function + Function URL | TODO | TODO |
| SCF 自定义域名 path mapping | TODO | TODO |
| 自定义 HTTPS 域名/证书 | TODO | TODO |
