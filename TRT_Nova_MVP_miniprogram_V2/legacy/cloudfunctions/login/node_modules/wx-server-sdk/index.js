    ...
    get() {
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                if (this.database.config.hasOwnProperty('throwOnNotFound')) {
                    throwOnNotFound = Boolean(this.database.config.throwOnNotFound);
                }
                else if ((_b = (_a = this.database.cloud) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.hasOwnProperty('throwOnNotFound')) {
                    throwOnNotFound = Boolean(this.database.cloud.config.throwOnNotFound);
                }
                const _id = this._id;
