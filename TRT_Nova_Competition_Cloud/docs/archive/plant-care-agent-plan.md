...
> **归档说明（2026-07-19）**：这是轻量 Agent 形成阶段的历史规划。当前 Agent 边界与实施顺序以 `../plant-pet-technical-architecture-target.md` 和 `../plant-pet-implementation-roadmap.md` 为准。
...
- [历史 Agent API 设计](./agent-api-design.md)
- [当前设备字段协议](../device-field-protocol.md)
- [历史 RAG 知识规划](./plant-rag-knowledge-plan.md)
- [历史植物库增强方案](./plant-library-enhancement-plan.md)
